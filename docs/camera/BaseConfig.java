...
public class BaseConfig {
    ...
    private int min_face_size = 346; //最小检测人脸的宽度 rect
    // 设备通信密码
...
//    private int radius = 50;
    ...
    private int illumination = 30;
    // 姿态阈值
    private float gesture = 30;
    ...
    // 遮挡阈值
    private float occlusion = 0.9f;
    // 左眼被遮挡的阈值，默认0.6
    private float leftEye = 0.9f;
    // 右眼被遮挡的阈值，默认0.6
    private float rightEye = 0.9f;
    // 鼻子被遮挡的阈值，默认0.7
    private float nose = 0.9f;
    // 嘴巴被遮挡的阈值，默认0.7
    private float mouth = 0.9f;
    // 左脸颊被遮挡的阈值，默认0.8
    private float leftCheek = 0.9f;
    // 右脸颊被遮挡的阈值，默认0.8
    private float rightCheek = 0.9f;
    // 下巴被遮挡阈值，默认为0.6
    private float chinContour = 0.9f;
    ...
    // RGB活体阀值
    private float rgbLiveScore = 0.40f;
    // NIR活体阀值
    ...
    // rgb和nir摄像头宽
    private int rgbAndNirWidth = 1920;
    // rgb和nir摄像头高
    private int rgbAndNirHeight = 1080;
    // depth摄像头宽
